...
- **Containers**: Containerfile provided for containerized deployment. `compose.yaml` runs the app with PostgreSQL and MinIO (standing in for B2) under `podman compose` for offline local development.
