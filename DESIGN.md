...
Unknown aliases cause the application to refuse to boot. Additional Swoosh adapters can be wired in by adding a new alias to this mapping in a future release.
